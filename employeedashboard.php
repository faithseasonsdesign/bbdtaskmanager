<?php
	...
	$employee_ref_username = $_SESSION['employeeUsername'];
	...
	$taskTbl = "tasks";
	$pendingTasksSql = "SELECT taskStatus FROM $taskTbl WHERE taskStatus='pending' AND assignedUserEmail ='$employee_ref_username';";
	...
	$taskTbl = "tasks";
	$completeTasksSql = "SELECT taskStatus FROM $taskTbl WHERE taskStatus='complete' AND assignedUserEmail ='$employee_ref_username';";
	...
	if(isset($_POST['editBtn'])){
		if($_SERVER['REQUEST_METHOD']=="POST"){
			...
			$_SESSION['editEmail'] = $_POST['edit_button'];
		}
	}
		...
		<div class="nav-wrapper  bg-dark text-white">
			<div class="container nav-child-wrapper d-flex align-items-center">
				...
				<div class="list-items-wrapper text-center container d-none d-sm-none d-md-flex justify-content-end">
					<li class="nav-link">
						<a href="employeedashboard.php" class="text-white">
							Dashboard
						</a>
					</li>
				</div>
			...
			<div class="dashboard-child-wrapper container py-5">
				...
				<div class="table-wrapper py-2 container-fluid" style="overflow-x:auto;">
					...
					<table class="table mt-3" style="border-collapse:collapse">
						...
						<tbody>
							<?php
								$sql = "SELECT * FROM $taskTbl WHERE assignedUserEmail = '$employee_ref_username'";
